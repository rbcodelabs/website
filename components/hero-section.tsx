...
import { SplitFlapText, SplitFlapAudioProvider, SplitFlapMuteToggle } from "@/components/split-flap-text"
      ...
      <div ref={contentRef} className="flex-1 w-full">
        <SplitFlapAudioProvider>
          <div className="relative">
            <SplitFlapText text="RB CODE" speed={80} />
            <div className="mt-4">
              <SplitFlapMuteToggle />
            </div>
          </div>
        ...
        <div className="mt-16 flex items-center gap-8 flex-wrap">
          ...
          >
            <ScrambleTextOnHover text="Our Work" as="span" duration={0.6} />
